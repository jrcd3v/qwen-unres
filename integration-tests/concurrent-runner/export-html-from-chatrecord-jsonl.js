...
<head>
  ...
  <script src="https://unpkg.com/@jrcdev/boros-code-webui@0.1.0-beta.1/dist/index.umd.js"></script>

  <!-- Load the CSS -->
  <link rel="stylesheet" href="https://unpkg.com/@jrcdev/boros-code-webui@0.1.0-beta.1/dist/styles.css">
  ...
  <div class="page-wrapper">
    <div class="header">
      <div class="header-left">
        ...
        <div class="logo">
          <div class="logo-text" data-text="BOROS">
            <span class="logo-text-inner">BOROS</span>
          </div>
        </div>
      </div>
      <div class="meta">
