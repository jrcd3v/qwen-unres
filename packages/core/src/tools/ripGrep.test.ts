...
describe('RipGrepTool', () => {
  ...
  describe('execute', () => {
    ...
    it('should pass .borosignore to ripgrep when respected', async () => {
      await fs.writeFile(
    ...
    it('should include .borosignore matches when disabled in config', async () => {
      await fs.writeFile(path.join(tempRootDir, '.borosignore'), 'kept.txt\n');
