  ...
  parametersJsonSchema: {
    ...
    properties: {
      ...
      scope: {
        type: 'string',
        description:
          'Where to save the memory: "global" saves to user-level ~/.boros/BOROS.md (shared across all projects), "project" saves to current project\'s BOROS.md (project-specific). If not specified, will prompt user to choose.',
        enum: ['global', 'project'],
      },
    },
    required: ['fact'],
...
- \`scope\` (string, optional): Where to save the memory:
  - "global": Saves to user-level ~/.boros/BOROS.md (shared across all projects)
  - "project": Saves to current project's BOROS.md (project-specific)
  - If not specified, the tool will ask the user where they want to save the memory.
`;

export const BOROS_CONFIG_DIR = '.boros';
export const DEFAULT_CONTEXT_FILENAME = 'BOROS.md';
export const MEMORY_SECTION_HEADER = '## Boros Added Memories';
