...
export function getInstallationInfo(
  ...
  try {
    ...
    if (realPath.includes('/.pnpm/global')) {
      const updateCommand = 'pnpm add -g @jrcdev/boros-code@latest';
      return {
    ...
    if (realPath.includes('/.yarn/global')) {
      const updateCommand = 'yarn global add @jrcdev/boros-code@latest';
      return {
    ...
    if (realPath.includes('/.bun/bin')) {
      const updateCommand = 'bun add -g @jrcdev/boros-code@latest';
      return {
    ...
    // Assume global npm
    const updateCommand = 'npm install -g @jrcdev/boros-code@latest';
    return {
