...
1. Extract components from `vscode-ide-companion/src/webview/` into an independent `@jrcdev/boros-code-webui` package
...
```typescript
// @jrcdev/boros-code-webui/src/context/PlatformContext.ts
...
```javascript
// @jrcdev/boros-code-webui/tailwind.preset.js
module.exports = {
  theme: {
    extend: {
      colors: {
...
```
Developer ──► @jrcdev/boros-code-webui ──► vscode-ide-companion
  │              │                      │
...
// After: Update import
import { FileIcon } from '@jrcdev/boros-code-webui';
// or import { FileIcon } from '@jrcdev/boros-code-webui/icons';
```
...
1. **Tailwind Class Name Tree Shaking**
   ...
   - Solution: Consumer's `content` config needs to include `node_modules/@jrcdev/boros-code-webui`
...
│     └── Edit files in @jrcdev/boros-code-webui/src/                     │
│                                                                  │
...
│     └── import { Component } from '@jrcdev/boros-code-webui'            │
...
1. **Single Source of Truth**: All UI components live in `@jrcdev/boros-code-webui`
