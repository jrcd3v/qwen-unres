 ...
 * All UI components are now imported from @jrcdev/boros-code-webui
 */
...
import type { BaseToolCallProps } from '@jrcdev/boros-code-webui';
...
export type { BaseToolCallProps, ToolCallData } from '@jrcdev/boros-code-webui';
